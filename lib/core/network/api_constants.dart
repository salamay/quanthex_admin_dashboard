class ApiConstants {
  ...
  // Mining referrals (admin)
  static String adminDirectReferrals = '$baseUrl/products/admin-direct-referrals';
  static String adminIndirectReferrals = '$baseUrl/products/admin-indirect-referrals';

  // Users
  static String users = '$baseUrl/users/all';
  static String userReferrals = '$baseUrl/users/user-referrals';
  static String userSubscriptions = '$baseUrl/users/user-subscriptions';
  static String completedHashUsers = '$baseUrl/users/completed-hash-users';
}
